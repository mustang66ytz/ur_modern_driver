...
URCommander_CB::URCommander_CB(URStream &stream, const URCommanderOpts &options)
  : URCommander(stream, options)
{
  std::ostringstream out;
...
URCommander_e::URCommander_e(URStream &stream, const URCommanderOpts &options)
  : URCommander(stream, options)
{
  std::ostringstream out;
  out << std::fixed << std::setprecision(5);
...
// URCommander_V3_1__2::URCommander_V3_1__2(URStream &stream, const URCommanderOpts &options)
//   : URCommander_V3_X(stream, options)
// {
//   std::ostringstream out;
//   out << std::fixed << std::setprecision(5);
//   out << ", " << 0.002;
...
// URCommander_V3_3::URCommander_V3_3(URStream &stream, const URCommanderOpts &options)
//   : URCommander_V3_X(stream, options)
// {
//   std::ostringstream out;
//   out << std::fixed << std::setprecision(5);
